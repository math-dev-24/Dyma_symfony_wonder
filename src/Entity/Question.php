...
class Question
{
    ...
    #[Assert\Length(min: 10, minMessage: "Veuillez détailler votre question", max: 255, maxMessage: "Le titre de la question est trop long")]
    private $title;
    ...
    public function getNbrResponse(): ?int
    {
        return $this->nbrResponse;
    }

    public function setNbrResponse(int $nbrResponse): self
    {
        $this->nbrResponse = $nbrResponse;
